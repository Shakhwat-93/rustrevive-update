...
export function CategoryExplorer() {
  ...
  return (
    <section className="w-full py-16 md:py-24 px-4 sm:px-6 lg:px-12 bg-[#141312]">
      <div className="max-w-[1600px] mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
            ...
            {CATEGORY_EXPLORER_DATA.map((cat) => {
              ...
              return (
                <Link
                  ...
                  className={`group flex items-center justify-between py-3.5 sm:py-4.5 border-b border-[#262421] transition-colors ${
                    isActive ? "text-[#fbf9f5]" : "text-[#666258] hover:text-[#fbf9f5]"
                  }`}
                >
          ...
          <div className="lg:col-span-5 relative aspect-[4/5] w-full overflow-hidden bg-[#1c1a18] hidden lg:block">
            <Image
              ...
              fill
              sizes="40vw"
              className="object-cover object-center animate-in fade-in duration-300 opacity-90"
            />
          </div>
        </div>
      </div>
