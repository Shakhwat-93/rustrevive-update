...
import { BarChart3, Calendar, DollarSign, ShoppingCart, Users, ArrowUpRight } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Conversion metrics, top-performing garments, and revenue trajectory.
          </p>
        </div>

        <div className="flex items-center space-x-1.5 bg-white border border-slate-200 p-1 rounded-lg text-xs">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs space-y-4">
        <h2 className="text-sm font-semibold text-slate-900">Top Selling Garments</h2>
