        ...
        <div className="max-w-md w-full mx-auto px-4 sm:px-6 space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs font-sans-ui text-[#5c574e]">
              Register to track your shipments, save wishlist pieces, and expedite checkout.
            </p>
          </div>
          ...
          <div className="bg-white border border-[#ded7c8] p-6 sm:p-8 shadow-xs">
            ...
            <form onSubmit={handleRegister} className="space-y-3.5 text-xs font-mono-meta">
              <div>
                <label className="block text-[#141312] font-semibold mb-1">Full Name *</label>
                <div className="relative flex items-center">
                  <User className="w-4 h-4 text-[#8c8577] absolute left-3" />
                  <input
                    type="text"
                    value={name}
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <Phone className="w-4 h-4 text-[#8c8577] absolute left-3" />
                  <input
                    type="tel"
                    value={phone}
              ...
              <div>
                <label className="block text-[#141312] font-semibold mb-1">Password *</label>
                <div className="relative flex items-center">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-[#141312] hover:bg-[#9e472a] text-[#fbf9f5] font-semibold uppercase tracking-wider transition-colors flex items-center justify-center space-x-2 cursor-pointer shadow-xs mt-2"
              >
